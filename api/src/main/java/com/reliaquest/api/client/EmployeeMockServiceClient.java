...
import com.reliaquest.api.EmplyeeClientMockResponse.EmployeeApiResponse;
        ...
        return retryTemplate.execute(
                context -> {
                    ResponseEntity<EmployeeApiResponse> response = restTemplate.exchange(
                            mockApiUrl, HttpMethod.GET, null, new ParameterizedTypeReference<EmployeeApiResponse>() {});
